...
class Logger(object):
    ...
    def __init__(self, eslam):
        ...
        # self.planes = eslam.shared_planes_xy
    ...
    def log(self, idx, keyframe_list):
        ...
        torch.save({
            ...
            'all_planes': (self.planes_xy, self.planes_xz, self.planes_yz, self.c_planes_xy, self.c_planes_xz, self.c_planes_yz, self.g_planes_xy, self.g_planes_xz, self.g_planes_yz),
            'idx': idx,
